...
function parseFichajesHTML(htmlContent, year) {
  ...
  for (let i = dataStartIndex; i < rows.length; i++) {
    ...
    // Enhance preview loading: fallback to server-side parser when client parser finds no records
    document.addEventListener('DOMContentLoaded', function() {
      const originalLoad = window.importFichajes && window.importFichajes.parseFichajesHTML;
      // nothing to do here; import page uses this script and will fetch server fallback when needed
    });
