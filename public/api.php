...
if ($method === 'POST' && $path === '/login') {
  ...
  // Rate limiting anti fuerza bruta (compartido con el login web)
  if (function_exists('login_is_rate_limited') && login_is_rate_limited()) {
  ...
  if (!$user_data) {
    if (function_exists('login_record_attempt')) login_record_attempt($username, false);
  ...
  if (function_exists('login_record_attempt')) login_record_attempt($username, true);
  LogConfig::jsonLog('auth', [
