...
require_once __DIR__ . '/caldav-vacaciones.php';
require_login();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_SERVER['HTTP_X_REQUESTED_WITH'])) {
    ...
    if ($action === 'add') {
        ...
        caldav_add_vacation($date, 'vacation');
        ...
        caldav_remove_vacation($date, 'vacation');
        ...
        caldav_add_vacation($date, 'LibreDisposicion');
        ...
        $del->execute([$user['id'], $date]);
        caldav_remove_vacation($date, 'LibreDisposicion');
...
$MAX_VERANO     = 23;  // Sin límite práctico en verano (se muestra el total disponible)
$MAX_INVIERNO   = 11;  // Máximo días de vacaciones en horario de invierno
...
<head>
  ...
  <style>
    ...
    .vac-finde   { background:#ffffff;color:#dc2626;font-weight:600;cursor:default; }
    .vac-festivo { background:#b91c1c;color:#ffffff;font-weight:700;cursor:default;border:1px solid #ef4444; }
    .vac-off     { background:#ffffff;color:#111827;font-weight:500; }
    .vac-on      { background:#00c853;color:#000000;font-weight:800;border:1px solid #00e676;text-shadow:none; }
    .vac-ld      { background:#ffe600;color:#000000;font-weight:800;border:1px solid #ffff00;text-shadow:none; }
    .vac-today   { border-color:#4a9eff !important;border-width:2px !important; }
    /* Leyenda */
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="vac-legend">
        <span><span class="vac-dot" style="background:#00c853;border:1px solid #00e676;"></span>Vacaciones</span>
        <span><span class="vac-dot" style="background:#ffe600;border:1px solid #ffff00;"></span>Libre disposición</span>
        <span><span class="vac-dot" style="background:#b91c1c;border:1px solid #ef4444;"></span>Festivo</span>
        <span><span class="vac-dot" style="background:#ffffff;border:1px solid #cbd5e0;"></span>Laborable</span>
        <span><span class="vac-dot" style="background:#ffffff;border:2px solid #4a9eff;"></span>Hoy</span>
